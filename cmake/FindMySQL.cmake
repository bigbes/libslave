...
ELSE (WIN32)
    ...
    NAMES libmysqlclient_r.a libmysqlclient.a
    PATHS /usr/lib/mysql
          /usr/local/lib/mysql
          /usr/local/mysql/lib
...
IF (MYSQL_INCLUDE_DIR AND MYSQL_LIB_DIR)
  ...
  MESSAGE(STATUS "MySQL client shared libraries: ${MYSQL_CLIENT_LIBS}")
  MESSAGE(STATUS "MySQL client static libraries: ${MYSQL_STATIC_LIB}")
